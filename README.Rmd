...
You can install the development version of DSPGGrocery from [GitHub](https://github.com/) with:
...
This functions in the package can also be used independently of the R Shiny tool by simply
calling the functions after loading the library.
