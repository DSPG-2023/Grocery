...
north_val <- as.integer(north_dist$rows$elements[[1]]$distance$value)
east_val <- as.integer(east_dist$rows$elements[[1]]$distance$value)
south_val <- as.integer(south_dist$rows$elements[[1]]$distance$value)
west_val <- as.integer(west_dist$rows$elements[[1]]$distance$value)
