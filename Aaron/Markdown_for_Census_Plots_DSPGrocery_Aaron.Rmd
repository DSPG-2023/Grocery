...
var_vector <- c("B19013_001", "B23025_003", "B23025_004", "B23025_005", "C16001_001", "C16001_002", "C16001_003", "C16001_006", "C16001_009", "C16001_012", "C16001_015","C16001_018", "C16001_021", "C16001_024", "C16001_027", "C16001_030", "C16001_033", "C16001_036")


get_census_vars_acs <- function(df, geography, var_vector) {
  ...
  state_vector <- as.numeric(unique(df$state))
...
acs_df <- get_census_vars_acs(city_county_state, "county", var_vector = var_vector)
...
decennial_df <- get_census_vars_decennial(df = city_county_state, "county", var_vector = decennialList)
...
plot2 <- plot5 %>% layout(annotations = list(list(x = 1, y = -0.1, text = "Source: American Community Survey (5-Year Average, 2021)", showarrow = FALSE, xref = 'paper', yref = 'paper', xanchor = 'right', yanchor = 'auto', font = list(size = 10, color = "grey50"))))
