...
The demographic data for this project is taken from the five-year American Community Survey(ACS) 2021.The plots in the dashboard showing the language,race, employment rate and median income uses the 2021 five-year ACS data.
...
## [US Census Bureau Data](https://www.census.gov/popclock/)

The population used in the function, `Avg_Capita_Grocery_Spending()`, of this project takes the US census population as of 01/01/2022.
...
The 2021 Sales Genie grocery sales data and dollar store data were used to visualize the distribution of the different types of stores and the sales volume information.
