...
df_geocode
#api_stores$UTM <- with(api_stores, oce::lonlat2utm(longitude = df_geocode$lng, 
#                                                   latitude = df_geocode$lat,
#                                                   zone = UTM_Zoner(lng = df_geocode$lng)))
...
df_geocode
api_stores$Lat_Diff <- with(api_stores, as.numeric(api_stores$Lat) -
                              as.numeric(df_geocode$lat))
api_stores$Long_Diff <- with(api_stores, as.numeric(api_stores$Long) - 
                               as.numeric(df_geocode$lng))
print(api_stores)

print(api_stores$Lat[1] - df_geocode$lat[1])
