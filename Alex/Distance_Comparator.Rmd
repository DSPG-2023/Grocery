...
#Depriciated, use Harun's function
...
#oh my god why does this not filter anything
northeast_dist <- df_new %>% filter(df_new$northing[1] > df_geocode$northing && df_new$easting[1] > df_geocode$easting)
