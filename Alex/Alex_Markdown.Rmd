...
file.path()
access <- read_xlsx(path = "usda_table_atlas.xlsx", sheet="ACCESS")
stores <- read_xlsx(path = "usda_table_atlas.xlsx", sheet="STORES")
assistance <- read_xlsx(path = "usda_table_atlas.xlsx", sheet="ASSISTANCE")
insecurity <- read_xlsx(path = "usda_table_atlas.xlsx", sheet="INSECURITY")
